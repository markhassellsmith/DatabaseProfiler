...
--
-- 1. This stored procedure is OPTIONAL
--    The DataProfiler application works fine without it (automatic fallback to dynamic SQL)
--
-- 2. Deploy this to get better performance:
--    - 30-40% faster profiling
--    - Additional statistics (string lengths, date ranges)
--
-- 3. How to deploy:
--    a. Connect to your target database in SSMS
--    b. Run this entire script (F5)
--    c. Repeat for each database you want to profile
--
-- 4. Requirements:
--    - SQL Server 2016 or later
--    - db_owner or CREATE PROCEDURE permission
--
-- 5. Safe to re-run:
--    - Uses ALTER PROCEDURE (requires the procedure to already exist)
--
-- For more details, see: DataProfiler.App/Docs/QUICK_START_V3.md
--
-- =============================================

ALTER PROCEDURE dbo.usp_ProfileTable
(
	@TableName sysname,
